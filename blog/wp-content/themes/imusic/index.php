        ...
        <div class="wrapper">
          <div class="flex_hori">
            <div class="member flex_vert">
              <p class="img_block"><img src="/assets/guitar.jpg" width="220" alt="imusic"></p>
            ...
            <div class="member flex_vert">
              <p class="img_block"><img src="/assets/bass.jpg" width="220" alt="imusic"></p>
              <h2 class="name">imusic</h2>
              <p class="descri">Bass, Vocal</p>
              <p class="equip">Eden WTDI, Behringer XM8500</p>
            </div>
            <div class="member flex_vert">
              <p class="img_block"><img src="/assets/key.jpg" width="220" alt="imusic"></p>
              <h2 class="name">imusic</h2>
